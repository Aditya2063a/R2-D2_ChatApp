        ...
        <DialogContent className="bg-[#181920]  border-none text-white w-[400px] h-[400px] flex flex-col">
          ...
          <div>
            <Input
              ...
              className="rounded-lg mt-4 p-6 bg-[#2c2e3b] border-none"
            ...
            <div className="flex flex-col gap-5">
              ...
              {searchedContacts.length <= 0 && (
                <div className="flex-1  md:flex mt-5  flex-col justify-center items-center hidden duration-1000 transition-all">
                  <SiFreepik className="text-9xl mr-6 mt-4 text-purple-500"/>
                  <div className="text-opacity-80 text-white  flex flex-col gap-5 items-center mt-8 lg:text-2xl text-xl transition-all duration-1000 text-center">
